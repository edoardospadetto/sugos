...
int main()
{
 ...
 //"ABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890.,!?"
  ...
  std::vector<float> noise_data = Perlin2D(1000, 1000, 3, 3,  43);
  ...
  */
  ...
  noise_t.LoadTexture(&w,&(noise_data[0]) ,1000, 1000, 1);
  ...
  noise_surf.LinkUniformToVariable("m_sizes", 2);
  noise_surf.LinkUniformToVariable("w_sizes", 2);
  
  noise_surf.SetUniform("w_sizes",0,640.0);
  noise_surf.SetUniform("w_sizes",1,640.0);
  noise_surf.SetUniform("m_sizes",0,1000);
  noise_surf.SetUniform("m_sizes",1,1000);
